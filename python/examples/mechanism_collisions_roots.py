...
# Create mechanism, options are '4R' are '6R' and '8R'
m = choose_mechanism("6R")

start = timer()
colls = m.collision_check()  # calculate collisions
time_elapsed = timer() - start

print("Time elapsed: ", timedelta(seconds=time_elapsed))

colls_true = [result for result in colls if True in result[1]]
