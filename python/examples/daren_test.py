...
mf1 = MotionFactorization(
    [NormalizedLine(factor.all_coeffs()[0].coeffs) for factor in factorization1]
)
mf2 = MotionFactorization(
    [NormalizedLine(factor.all_coeffs()[0].coeffs) for factor in factorization2]
)
...
mf1 = MotionFactorization([NormalizedLine(h1), NormalizedLine(h2), NormalizedLine(h3)])
mf2 = MotionFactorization([NormalizedLine(k1), NormalizedLine(k2), NormalizedLine(k3)])

m = RationalMechanism([mf1, mf2])
m = RationalMechanism([mf1])
