...
**IMPORTANT NOTE:** there has been updates to Rational Linkages, therefore the values output of
the method :meth:`.RationalMechanism.get_design` will differ. However, to keep consistency with
the Onshape models shared bellow, the old values are kept here. To obtain mechanism design for your
particular linkage, generate STEP model as shown in :ref:`cad_tutorial` tutorial.
...
.. literalinclude:: /examples/d_ark2024_bennett.py
    :language: python
...
.. literalinclude:: /examples/d_ark2024_parallel_colls.py
    :language: python
...
**IMPORTANT NOTE:** there has been updates to Rational Linkages, therefore the values ``cp`` of the connection
points yield by method :meth:`.RationalMechanism.get_design` will differ. However, to keep consistency with
the Onshape models shared bellow, the old values are kept here. To obtain mechanism design for your
particular linkage, generate STEP model as shown in :ref:`cad_tutorial` tutorial.
...
in the model as show via **red arrow** in the figure below. It might happen that the link
